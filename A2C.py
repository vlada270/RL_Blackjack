...
class A2C_discrete():
    ...
    def train(self):
        ...
        """A2C update"""
        # Slice long trajectopy into short trajectory and perform mini-batch A2C update
        ...
        for _ in range(self.K_epochs):
            ...
            for i in range(optim_iter_num):
                ...
                a_loss = -(torch.log(prob_a) * adv[index].detach()).mean()
        ...
        return a_loss.mean(), c_loss.mean(), entropy, self.lr
    ...
    def save(self, episode):
        torch.save(self.critic.state_dict(), "./model/a2c_critic{}.pth".format(episode))
        torch.save(self.actor.state_dict(), "./model/a2c_actor{}.pth".format(episode))

    def load(self, episode):
        self.critic.load_state_dict(torch.load("./model/a2c_critic{}.pth".format(episode), map_location=self.dvc))
        self.actor.load_state_dict(torch.load("./model/a2c_actor{}.pth".format(episode), map_location=self.dvc))
