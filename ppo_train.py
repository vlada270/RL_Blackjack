...
opt.clip_rate = 0.2
opt.K_epochs = 10 # PPO update times
opt.net_width = 64 # Hidden net width
opt.lr = 1e-4 # Learning rate
opt.l2_reg = 0 # L2 regulization coefficient for Critic
opt.batch_size = 64 # lenth of sliced trajectory
opt.entropy_coef = 0.0 # Entropy coefficient of Actor
opt.entropy_coef_decay = 0.99 # Decay rate of entropy_coef
